...
"""
Debugging asyncio code - logging slow async calls in production.
Notice! This requires:
 - attrs==19.1.0
 - aiodebug==1.1.2
To run:
    $ pytest part-6/mayhem_3.py
...
async def save(msg):
    # Will trigger asyncio to log out the slower than 100ms async call
